...
INSERT INTO messages(sender_id, receiver_id, text, timestamp) VALUES
	...
	(2, 1, 'user 2 to 1: I will send you some random text', '2024-05-05 20:02:53'), --
	(2, 1, 'random1', '2024-05-06 20:02:53'),
	(2, 1, 'random2', '2024-05-07 20:02:53'),
	(2, 1, 'random3', '2024-05-08 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	...
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4 random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	...
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(2, 1, 'random4', '2024-05-09 20:02:53'),
	(1, 2, 'user 1 to 2: hello user 2', '2024-01-06 20:02:53'),
	(1, 2, 'user 1 to 2: hello user 2', '2024-01-07 20:02:53'),
	(1, 2, 'user 1 to 2: hello user 2', '2024-01-09 20:02:53'),
	(1, 2, 'user 1 to 2: hello user 2', '2024-01-10 20:02:53'), --
